...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        neighbor_length: int = Input(description="Length of local neighboring frames. Lower = faster, higher = smoother.", default=5),
        subvideo_length: int = Input(description="Length of sub-video for long video inference. Lower = faster & less memory.", default=20),
